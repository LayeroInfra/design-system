    ...
    docs: {
      description: {
        component: [
          ...
          "   и линия торчала бы из-под скруглённой подсветки. Шапка при этом ведёт себя",
          "   ровно как строка — фон на ячейках, скругления по краям таблицы: при",
          "   горизонтальной прокрутке край скруглён, середина нет.",
          ...
          "   `sticky` на самом `thead`. Там же обе оси прокрутки лежат на одном",
          "   элементе — иначе `sticky` меряется по горизонтальному контейнеру, внутри",
          "   которого вертикально ничего не двигается, и шапка не липнет ни к чему.",
          "   Значит `inset`-таблице нужна высота: `wrapperClassName=\"h-full\"` и родитель",
          "   с `overflow-hidden`.",
...
export const Inset: Story = {
  ...
  render: () => (
    <div className="h-64 overflow-hidden bg-card">
      <Table flush inset wrapperClassName="h-full">
