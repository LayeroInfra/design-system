...
/** Checkbox row. The tick sits on the trailing edge: the label starts where
 *  every other menu row starts, so a list of options reads as a list of
 *  names — the checked ones are answered on the right, at the end of the
 *  line, instead of shifting all labels one indent to the right. */
